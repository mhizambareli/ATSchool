...
import lesson13.com.fruitbase.fruits.*;
...
public class FruitCatalogue {
    ...
    public FruitCatalogue() {
        ...
        lesson13.com.fruitbase.fruits.Orange orange = new Orange(5, BigDecimal.valueOf(541.36), "Orange");
        lesson13.com.fruitbase.fruits.Banana banana = new Banana(3.5, BigDecimal.valueOf(321.05), "Banana");
        lesson13.com.fruitbase.fruits.Pineapple pineapple = new Pineapple(8.2, BigDecimal.valueOf(596.12), "Pineapple");
